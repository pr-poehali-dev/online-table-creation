...
const EXPORT_URL = 'https://functions.poehali.dev/194884f3-89a8-4cca-93d6-ab8f0a62a4b3';
...
const Index = () => {
  ...
  const exportToCSV = () => {
    window.open(`${EXPORT_URL}?sheet_id=1&format=csv`, '_blank');
    toast({
      title: 'Экспорт CSV',
  ...
  const exportToExcel = () => {
    window.open(`${EXPORT_URL}?sheet_id=1&format=excel`, '_blank');
    toast({
      title: 'Экспорт Excel',
      description: 'Файл скачивается...'
    });
    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-pink-50 to-blue-50">
      <div className="container mx-auto p-6">
        ...
        <div className="bg-white rounded-xl shadow-lg border border-purple-100 overflow-hidden">
          <div className="border-b border-purple-100 p-4 bg-gradient-to-r from-purple-50 to-pink-50 flex gap-2 flex-wrap">
            ...
            <Button onClick={exportToCSV} className="gap-2 bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-700 hover:to-emerald-700">
              <Icon name="Download" size={16} />
              CSV
            </Button>
            <Button onClick={exportToExcel} className="gap-2 bg-gradient-to-r from-blue-600 to-cyan-600 hover:from-blue-700 hover:to-cyan-700">
